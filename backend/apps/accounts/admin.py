...
class UnavailableDateAdmin(admin.ModelAdmin):
    list_display = ("counsellor", "date", "reason", "created_at")
    list_filter = ("date", "counsellor")
    search_fields = ("counsellor__email", "counsellor__first_name", "counsellor__last_name", "reason")
    date_hierarchy = "date"
    ordering = ["-date"]
